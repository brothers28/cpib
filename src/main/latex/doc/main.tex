...
% TODO: Macht es sinn, dass und was hier zu && und || beschrieben wurde
...
% TODO: Beschreiben anhand von Methode executeInitCheck und Code in den ensprechenden Klassen refactoren und Variabeln umbenennen etc.
...
\label{ieee}
% TODO: Zweierkomplement oben noch nicht beschrieben. Bem: Muss das gemacht werden? Es sollte doch Hr. Lederer bekannt sein, was das Zweierkomplement ist.
