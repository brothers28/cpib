...
public class Term2NTS extends Production implements ITerm2NTS {
    ...
    public Term2NTS(final IToken t_addOpr,
    ...
    public ch.fhnw.edu.cpib.ast.interfaces.IExpr toAbsSyn(IExpr expr) {
        ch.fhnw.edu.cpib.ast.interfaces.IExpr temp = new ch.fhnw.edu.cpib.ast.AddExpr(((Operator)T_addOpr).getOperator(), expr, N_term3.toAbsSyn());
