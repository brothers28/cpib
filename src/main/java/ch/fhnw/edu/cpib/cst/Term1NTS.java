...
public class Term1NTS extends Production implements ITerm1NTS {
    ...
    public Term1NTS(final IToken t_relOpr,
    ...
    public ch.fhnw.edu.cpib.ast.interfaces.IExpr toAbsSyn(IExpr expr) {
        ch.fhnw.edu.cpib.ast.interfaces.IExpr temp = new ch.fhnw.edu.cpib.ast.RelExpr(((Operator)T_relOpr).getOperator(), expr, N_term2.toAbsSyn());
