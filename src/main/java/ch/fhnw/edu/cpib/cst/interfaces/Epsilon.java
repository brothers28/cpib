...
public interface Epsilon {
    ...
    class CpsDeclNTS extends Production implements ICpsDeclNTS {
        @Override
        public ArrayList<ch.fhnw.edu.cpib.ast.interfaces.IDecl> toAbsSyn(ArrayList<IDecl> temp) {
            return temp;
        }
    }
    ...
    class CpsCmdNTS extends Production implements ICpsCmdNTS {
        @Override
        public ArrayList<ch.fhnw.edu.cpib.ast.interfaces.ICmd> toAbsSyn(ArrayList<ch.fhnw.edu.cpib.ast.interfaces.ICmd> temp) {
            return temp;
        }
    }
    ...
    class IfElseNTS extends Production implements IIfElseNTS {
        @Override
        public ch.fhnw.edu.cpib.ast.CpsCmd toAbsSyn() {
            return null;
        }
    }
    ...
    class ExprNTS extends Production implements IExprNTS {
        @Override
        public ch.fhnw.edu.cpib.ast.interfaces.IExpr toAbsSyn(ch.fhnw.edu.cpib.ast.interfaces.IExpr expr) {
            return expr;
        }
    }
    ...
    class ExprListLParenNTS extends Production implements IExprListLparenNTS {
        @Override
        public ArrayList<ch.fhnw.edu.cpib.ast.interfaces.IExpr> toAbsSyn() {
            return new ArrayList<>();
        }
    }
    ...
    class ExprListNTS extends Production implements IExprListNTS {
        @Override
        public ArrayList<ch.fhnw.edu.cpib.ast.interfaces.IExpr> toAbsSyn(ArrayList<ch.fhnw.edu.cpib.ast.interfaces.IExpr> temp) {
            return temp;
        }
    }
