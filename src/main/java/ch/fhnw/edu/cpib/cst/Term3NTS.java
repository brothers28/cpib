...
public class Term3NTS extends Production implements ITerm3NTS {
    ...
    public Term3NTS(final IToken t_multOpr,
    ...
    @Override
    public ch.fhnw.edu.cpib.ast.interfaces.IExpr toAbsSyn(IExpr expr) {
        ch.fhnw.edu.cpib.ast.interfaces.IExpr temp = new ch.fhnw.edu.cpib.ast.MultExpr(((Operator)T_multOpr).getOperator(), expr, N_factor.toAbsSyn());
