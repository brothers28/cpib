...
public class ProcDecl extends Production implements IProcDecl {
    ...
    public ProcDecl(final IToken t_proc,
    ...
    public ch.fhnw.edu.cpib.ast.interfaces.IDecl toAbsSyn() {
        return new ch.fhnw.edu.cpib.ast.ProcDecl((Ident)T_ident, N_paramList.toAbsSyn(), N_procDeclNTS.toAbsSyn(), N_cpsCmd.toAbsSyn());
    }
}
