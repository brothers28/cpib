...
public class AbsSynTree {
	...
	public void doScopeChecking() throws NameAlreadyDeclaredError, NameNotDeclaredError, NameAlreadyGloballyDeclaredError,
			LRValueError, AlreadyInitializedError, InvalidParamCountError {
	...
	public void doInitChecking() throws NotInitializedError, AlreadyInitializedError, GlobalInitializationProhibitedError,
