...
public class Param extends Production implements IParam {
    ...
    public Param(final IFlowModeNTS N_flowModeNTS,
    ...
    @Override
    public ch.fhnw.edu.cpib.absSynTree.Param toAbsSyn() {
        return new ch.fhnw.edu.cpib.absSynTree.Param(N_flowModeNTS.toAbsSyn(), N_mechModeNTS.toAbsSyn(), N_changeModeNTS.toAbySyn(), N_typedIdent.toAbsSyn());
    }
}
